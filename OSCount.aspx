<%@ Page Language="C#" MasterPageFile="~/counter.master" AutoEventWireup="true" CodeFile="OSCount.aspx.cs" Inherits="OSCount" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="font-size: 9pt; width: 508px">
        ...
        <tr>
            <td>
                total<asp:Label ID="labOS" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr>
            <td>
